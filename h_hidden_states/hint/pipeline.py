...
from h_hidden_states.hint.model_handler import generate_completion, load_model_and_tokenizer
...
def save_results(results: List[Dict], dataset_name: str, hint_type: str, model_name:str, n_questions: int):
    ...
    output_path = os.path.join("h_hidden_states/outputs/hints/", dataset_name, model_name, hint_type, f"completions_with_{str(n_questions)}.json")
    try:
...
def generate_dataset_completions(
    ...
    output_location: str = "h_hidden_states/hint/outputs",
):
    """
